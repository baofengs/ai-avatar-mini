  ...
  return [
    {
      ...
      userName: 'binnie',
      userHeadImg:
        'http://wx.qlogo.cn/mmhead/uI5pczeERTajXl904XSbHwAtGENC5ccKvo2F54sgYeqibHxOXNAFKdg/132',
      subCommentList: [
        {
          comment: '界面更不容易被逻辑阻塞，进一步减少卡顿。',
          userName: '拖拉机🚜',
          userHeadImg:
            'https://res.wx.qq.com/op_res/0AG3_hOKnGAqBhAhBx_a__0nu3Q_hGgnBQgiQhJMqZrvroKqdtYXhcSUdlp59bXjx7qF-ddTwGCcB-AqzYmlrw',
    ...
    },
    {
      ...
      subCommentList: [
        ...
        {
          comment:
            '基于 Worklet 机制的 手势系统。在渲染线程同步监听手势、执行手势相关逻辑；支持手势协商处理；',
          userName: '小苹果🍎',
          userHeadImg:
    ...
    {
      comment:
        'Skyline 能很好地保持和原有架构的兼容性，基于 WebView 环境的小程序代码基本上无需任何改动即可直接在新的架构下运行。',
      userName: '小苹果🍎',
      userHeadImg:
        'https://res.wx.qq.com/op_res/0-l2fyKjv3_BR62E3KwTJBAK7KJg9KId_6N1-rJ4OyCCQoJGVMOaTabboo2viRucoxkPvHRkn2fVl6tectlzBg',
      subCommentList: [],
    ...
    },
    {
      ...
      subCommentList: [
        {
          comment:
            '提供如 timing、spring 等常见动画方式的封装方法，开发者可自定义动画曲线，同时可对不同的动画类型进行组合、重复，形成交织动画。😄',
          userName: 'binnie',
          userHeadImg:
            'http://wx.qlogo.cn/mmhead/uI5pczeERTajXl904XSbHwAtGENC5ccKvo2F54sgYeqibHxOXNAFKdg/132',
          replyUserName: '流星雨',
    ...
    {
      comment:
        'Skyline 中 wxs 代码运行在 AppService 线程，而事件产生在 UI 线程，因此 wxs 动画 性能有所降低，为了提升小程序交互体验的效果，我们内置了一批手势组件。',
      userName: '落日余晖',
      userHeadImg:
        'https://res.wx.qq.com/op_res/7_miJnK0wxIrh5bV2QqvYYjda9Dp372N3T05q_nn3PgvoXBoReXvaXBfkthtXQLN7m5_YI6FoTre-xvJBDFLMA',
      subCommentList: [
        ...
        {
          comment:
            '手势组件直接在 UI 线程响应，避免了传递到 JS 线程带来的延迟；',
          userName: '落日余晖',
          userHeadImg:
            'https://res.wx.qq.com/op_res/7_miJnK0wxIrh5bV2QqvYYjda9Dp372N3T05q_nn3PgvoXBoReXvaXBfkthtXQLN7m5_YI6FoTre-xvJBDFLMA',
          replyUserName: 'binnie',
    ...
    {
      comment:
        '在连续的 Skyline 页面间跳转时，可实现自定义路由效果，路由动画的曲线、时长均可交由开发者控制。',
      userName: 'binnie',
      userHeadImg:
        'http://wx.qlogo.cn/mmhead/uI5pczeERTajXl904XSbHwAtGENC5ccKvo2F54sgYeqibHxOXNAFKdg/132',
      subCommentList: [],
    ...
    {
      comment:
        '在连续的两个 Skyline 页面跳转时，可以将上一个页面的元素“共享”到下一个页面，并伴随着过渡动画。',
      userName: '绿意盎然',
      userHeadImg:
